...
//		}
        ...
        String myPassword = "m4nD0izTehBEs7";
        String myHashedPassword = BCrypt.hashpw(myPassword, BCrypt.gensalt(12));
        boolean pwHashMatch = BCrypt.checkpw("m4nD0izTehBEs7", myHashedPassword);
        boolean pwHashMatch2 = BCrypt.checkpw("mashbsdw4uer^&kjnsd", myHashedPassword);

        System.out.println(pwHashMatch);
        System.out.println(pwHashMatch2);
